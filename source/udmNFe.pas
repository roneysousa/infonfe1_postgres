...
begin
     ...
     try
          ...
          try
               ...
               XMLDoc.Active:= True;
               aMensagem.Add('O arquivo '+ arquivoXMLNFe + ' é um XML VÁLIDO.');
               aMensagem.Add('');
               XMLDoc.Active:= False;
               Result := true;
          except
              ...
              begin
                 aMensagem.Add('O arquivo '+ arquivoXMLNFe + ' é um XML INVÁLIDO. Verifique: ');
                 aMensagem.Add('');
            ...
            begin
                 ...
                 With ACBrNFe1.NotasFiscais.Add.NFe do
                  begin
                       ...
                       End;   // fim-do-enquanto produdos e serviços
